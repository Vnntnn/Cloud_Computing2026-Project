...
# accounts through the in-cluster auth Service and 15 events in event_db.
#
...
EVENT_URL="postgres://event_svc:$(rds EVENT_SVC_PASSWORD)@$(rds host):$(rds port)/event_db?sslmode=require"
