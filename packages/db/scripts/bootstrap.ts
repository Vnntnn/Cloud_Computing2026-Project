...
const SERVICES = [
  // auth_db's schema is GENERATED by the better-auth CLI (SYSTEM-DESIGN §4.2),
  // but the migration mechanics are drizzle-kit's, same as the other two — the
  // better-auth CLI cannot migrate a Drizzle setup, only emit the schema.
